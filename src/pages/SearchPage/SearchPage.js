...
import { Nav, Col, Row, Container, Button, Card } from "react-bootstrap"
                                    ...
                                    <Col xs={12} md={6} lg={3} className="mb-3" key={idx}>
                                        <Card className="shadow-sm border-0 rounded-0" style={{ width: '100%' }}>
                                            ...
                                            <Card.Body>
                                                ...
                                                <Button className="action" onClick={() => { addSong({ title: title, album: album, artist: artistsNames, artwork: artwork, audio: audio, spotify: true }) }} variant="primary">Add to Library</Button>
                                            </Card.Body>
                                        </Card>
                                    </Col>

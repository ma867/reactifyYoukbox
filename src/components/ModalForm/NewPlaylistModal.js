...
export default function NewPlaylistModal({
  setPlaylistSongs, playlistSongs, songs, showModal, setShowModal, handlePlaylistSubmit, handlePlaylistChange, playlistFormData, setShowNewPlaylist, setPlaylistArtwork, uploader, options
}) {
  ...
  return (
    ...
    <>
      <Modal
        show={showModal} onHide={() => { setShowModal(false); setShowNewPlaylist(false) }} size='lg'

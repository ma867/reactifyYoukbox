...
export default function UpdatePlaylistModal({ updatePlaylistInfo, setUpdatedArtwork, updatedArtwork, handleChangeUpdate, playlist, showUpdatePlaylist,
    ...
    return (
        <Modal show={showModal} onHide={() => { setShowModal(false); setShowUpdatePlaylist(false); }} size="lg"
